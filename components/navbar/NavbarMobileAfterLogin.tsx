  ...
  return (
    ...
    >
      <div className={`container d-flex mt-auto`}>
        ...
        <ul className="navbar-nav mt-auto mb-auto ms-auto mb-lg-0"></ul>
        {windowWidth < 992 && (
          <li
            className={`d-flex ${styles.language_dropdown} text-center ps-2 me-4 mt-auto mb-auto nav-item dropdown text-white pe-2`}
          >
            <a
              className={`nav-link dropdown-toggle`}
              id="navbarDropdown"
            ...
            >
              {language === "th" && (
                <Flag className={`${styles.flag_size}`} country="TH" />
              )}
              {language === "eng" && (
                <Flag className={`${styles.flag_size}`} country="US" />
              )}
              {language === "id" && (
                <Flag className={`${styles.flag_size}`} country="ID" />
              )}
            </a>
            <ul
              className={`dropdown-menu dropdown-menu-dark`}
            ...
            >
              <li>
                ...
                >
                  <Flag country="US" className={`${styles.flag_size} pe-2`} />{" "}
                  English
                </a>
                <a
                  className={`dropdown-item ${styles.language_list} `}
                ...
                >
                  <Flag country="TH" className={`${styles.flag_size} pe-2`} />{" "}
                  Thai
                </a>
                <a
                  className={`dropdown-item ${styles.language_list}`}
                ...
                >
                  <Flag country="ID" className={`${styles.flag_size} pe-2`} />{" "}
                  Indonesia
                </a>
              </li>
            </ul>
