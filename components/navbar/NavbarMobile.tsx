...
export const NavbarMobile: React.FC = () => {
   ...
   return (
      <>
         <nav className={`${noto_sans_thai.className} border navbar navbar-expand-lg navbar-dark bg-dark fixed-top`}>
            <div className={`border container d-flex mt-auto`}>
               ...
               {windowWidth < 992 &&
                  (
                     <li className={`d-flex ${styles.language_dropdown} border text-center ps-2 me-4 mt-auto mb-auto nav-item dropdown`}>
                        <a
               ...
               <div className={`${styles.navcollapse} collapse navbar-collapse`} id="navbarSupportedContent">
                  ...
                  <ul className="navbar-nav mt-auto mb-auto ms-auto mb-lg-0">
                     {windowWidth >= 992 &&
                        (
                           <li className={`${styles.language_dropdown} border text-center ms-2 mt-auto mb-auto nav-item dropdown`}>
                              <a
                                 className={`nav-link dropdown-toggle`}
                                 id="navbarDropdown"
                                 data-bs-toggle="dropdown"
